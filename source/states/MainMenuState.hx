							...
							FlxFlicker.flicker(spr, 1, 0.06, false, false, function(flick:FlxFlicker)
							{
								...
								switch (daChoice)
								{
									case 'story_mode':
										...
										PlayState.storyPlaylist = ["goluy"];
										PlayState.isStoryMode = true;

										PlayState.storyWeek = 0;

										PlayState.SONG = PlayState.SONG = Song.loadFromJson(PlayState.storyPlaylist[0] + "-hard", PlayState.storyPlaylist[0]);
